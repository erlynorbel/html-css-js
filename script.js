...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const contactAlertModalEl = document.getElementById('contactAlertModal');
    const contactAlertModalTitle = document.getElementById('contactAlertModalTitle');
    const contactAlertModalBody = document.getElementById('contactAlertModalBody');
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            const showFormAlert = (msg, type = 'info', title = 'Notice') => {
                // Show as Bootstrap modal (same style as project cards)
                if (contactAlertModalEl && window.bootstrap) {
                    contactAlertModalTitle.textContent = title;
                    contactAlertModalBody.textContent = msg;
                    const modal = window.bootstrap.Modal.getOrCreateInstance(contactAlertModalEl);
                    modal.show();
                    return;
                }
    ...
    // No inline alert anymore; using Bootstrap modal.
    ...
    if (portfolioSection) {
        portfolioSection.addEventListener('click', (e) => {
            ...
            if (card && portfolioSection.contains(card)) {
